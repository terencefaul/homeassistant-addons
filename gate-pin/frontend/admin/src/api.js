...
export const orderGrants = (ids) => j('POST', 'api/admin/grants/order', { ids })
...
export const reissue = (id, kinds) => j('POST', `api/admin/grants/${id}/reissue`, { kinds })
export const getPresets = () => call('api/admin/presets')
export const savePreset = (payload) => j('POST', 'api/admin/presets', payload)
export const orderPresets = (ids) => j('POST', 'api/admin/presets/order', { ids })
